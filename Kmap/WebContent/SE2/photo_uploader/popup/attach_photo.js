	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/Kmap/SE2/photo_uploader/popup/file_uploader.jsp',	//샘플 URL입니다.
 			//sUrl  : '/file_uploader.do',	//샘플 URL입니다.
 	        sCallback : '/Kmap/SE2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
