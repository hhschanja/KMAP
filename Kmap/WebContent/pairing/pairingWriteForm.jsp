...
<section>
<form id="frm" action="./pairingInsert.pairing" method="post" enctype="multipart/form-data">
<input type="hidden" name="writer" value="${admin.id}">
<table>
<tr><td id="table_title">작성자</td></tr>
<tr><td id="table_input"><input style="width: 50%;" type="text" name="title" class="confirm" value="${sessionScope.admin.id}" readonly="readonly"></td></tr>
<tr><td id="table_title">제목</td></tr>
<tr><td id="table_input"><input style="width: 50%;" type="text" name="title" class="confirm"></td></tr>
