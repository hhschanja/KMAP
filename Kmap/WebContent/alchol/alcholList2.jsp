...
<c:import url="../temp/header.jsp"/>
	...
	<section>
		...
		<form class="section_top_searchBox" action="alcholList_2.alchol">
		...
		<h2 class="param_type">${param.type }</h2>
		<c:forEach items="${alcholList }" varStatus="i" var="alchol">
			<div class="alchol_List">
				<a href="alcholView.alchol?anum=${alchol.anum }&atype=${param.type }"> <img
					class="img" alt="" src="../upload/${files[i.index]}"></a>
			
				<div class="title">
					<a href="alcholView.alchol?anum=${alchol.anum }&atype=${param.type }" >${alchol.name } </a>
				</div>
